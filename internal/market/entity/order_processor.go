...
func (op *OrderProcessor) UpdatPositions(shares int) {
	op.Transaction.BuyingOrder.Investor.AdjustAssetPosition(op.Transaction.SellingOrder.Asset.ID, -shares)
